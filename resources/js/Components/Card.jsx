...
function Card({songName,artistName, songImage, songLength, changeData}) {
  ...
  return (
    <div class="bg-gray-100 shadow-lg rounded p-3">
        <div class="group relative">
          <img class="w-full md:w-72 block rounded" src={songImage} alt="artistprofile" />
          <div class="absolute bg-black rounded bg-opacity-0 group-hover:bg-opacity-60 w-full h-full top-0 flex items-center group-hover:opacity-100 transition justify-evenly">
            ...
            localStorage.setItem('aa',JSON.stringify(songName))
